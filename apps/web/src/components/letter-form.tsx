				...
				<Box sx={{ display: "flex", alignItems: "center", gap: 0.5, mt: isInternal ? 0 : "80px" }}>
					...
					{isInternal ? (
						<Autocomplete
							...
							options={[
								"ስራ አመራር ዋና ስራ አስፈፃሚ",
								"ማህበረሰብ ተሳትፎና የመጀመሪያ ደረጃ ጤና ክብካቤ መሪ ስራ አስፈፃሚ",
								"ፖሊሲና ስትራቴጂ ጥናትና ምርምር መ/ስ አስፈፃሚ",
								"ተቋማዊ ለዉጥ ስራ አስፈፃሚ",
								"ሜዲካል አገልግሎት መሪ ስራ አስፈፃሚ",
								"መድሃኒት፣ የህክምና መሳሪያዎችና/መ መ/ስ/አ",
								"ዲጂታል ጤና መሪ ስራ አስፈፃሚ",
								"ጤና መሰረተ ልማት መሪ ስራ አስፈፃሚ",
								"ብቃትና ሰዉ ሃብት አስተዳደር ስራ አስፈፃሚ",
								"ጤና ዘርፍ የሰዉ ሃብት ልማትና ማሻሻያ መ/ስ/አ",
								"መሰረታዊ አገልግሎት ስራ አስፈፃሚ",
								"ህዝብ ግንኙነትና ኮሚኒኬሽን ስራ አስፈፃሚ",
								"በሽታ መከላከልና መቆጣጠር መሪ ስራ አስፈፃሚ",
								"እናቶች ፣ህፃናትና አፍላ ወጣቶች ጤና አገልግሎት መሪ ስራ አስፈፃሚ",
								"ፋይናንስ ስራ አስፈፃሚ",
								"ግዥ ስራ አስፈፃሚ",
								"ኤች.አይ.ቪ ኤድስ መ/መ  መሪ ስራ አስፈፃሚ",
								"ህግ ጉዳዮች ስራ አስፈፃሚ",
								"ሥነ - ምግባርና ፀረ ሙስና ስራ አስፈፃሚ",
								"ዉስጥ ኦዲት ስራ አስፈፃሚ",
								"ስትራቴጂክ ጉዳዮች ስራ አስፈፃሚ",
								"ሴቶችና ማህበራዊ ጉዳዮች አካቶ ትግበራ ስ/አ",
								"ኢንፎርሜሽንና ኮሚኒኬሽን ቴክኖሎጅ ስ/አስፈፃሚ",
								"ሥርዓተ ምግብ ማስተባበሪያ መሪ ስራ አስፈፃሚ",
								"ጤናና ጤና ነክ ተ/ባለሙያዎች ቁጥጥር መ/ስ/አ",
							]}
							value={formData.to}
